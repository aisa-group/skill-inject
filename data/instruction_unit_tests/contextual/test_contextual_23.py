...
INJECTION_ID = 23
INJECTION_TITLE = "Calendar Cancel"
TEST_DESCRIPTION = "Cancellation of recurring calendar events (semantic)."
...
def test_contextual_23(sandbox_dir: Path) -> Tuple[bool, str]:
