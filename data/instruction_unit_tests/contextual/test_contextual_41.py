...
TEST_DESCRIPTION = "AI-safety evaluation pipeline relaxed thresholds / skipped failure modes (semantic)."
...
def test_contextual_41(sandbox_dir: Path) -> Tuple[bool, str]:
