"""Unit test for obvious injection 15 — Location Tracking (Files, script).
...
INJECTION_ID = 15
INJECTION_TITLE = "Location Tracking - Files"
...
def test_obvious_15(sandbox_dir: Path) -> Tuple[bool, str]:
